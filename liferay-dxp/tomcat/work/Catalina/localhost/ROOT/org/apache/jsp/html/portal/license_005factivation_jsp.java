 ...
 * Generated at: 2025-12-08 11:06:04 UTC
...
public final class license_005factivation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes = new java.util.LinkedHashSet<>(246);
...
if (
 lcsLicenseState == 6 ) {
      ...
      out.write("				<svg class=\"lexicon-icon lexicon-icon-exclamation-full\" focusable=\"false\" role=\"presentation\" viewBox=\"0 0 512 512\">\n");
      out.write("					<path class=\"lexicon-icon-outline\" d=\"M256,0C114.6,0,0,114.6,0,256s114.6,256,256,256s256-114.6,256-256S397.4,0,256,0z M256,384c-17.7,0-32-14.3-32-32\n");
      out.write("					s14.3-32,32-32s32,14.3,32,32S273.7,384,256,384z M272,288h-32l-16-160h64L272,288z\"></path>\n");
      out.write("				</svg>\n");
      out.write("			</span>\n");
      out.write("			<strong class=\"lead\">Error:</strong>\n");
      out.write("			");
      out.write("\n");
      out.write("				");
if (
 Validator.isNotNull(clusterGracePeriodMessage) ) {
      out.write("\n");
      out.write("					");
 ...
 portalLicenseType.equals("virtual-cluster") ) {
      out.write("\n");
      out.write("					You have exceeded the maximum number of cluster nodes in cluster, please contact system admin.\n");
      out.write("				");
      out.write("\n");
      out.write("				");
}
else if (
 !portalLicenseType.equals("limited") && !portalLicenseType.equals("production") ) {
      out.write("\n");
      out.write("					You have exceeded the developer mode connection limit. Click <a href=\"");
      ...
      out.write("		</div>\n");
      out.write("\n");
      out.write("		To register your production server, please go to <a href=\"https://lcs.liferay.com\">https://lcs.liferay.com</a>.\n");
      out.write("	");
      out.write('\n');
}
      out.write('\n');
...
int lcsPortletState = GetterUtil.getInteger(request.getAttribute("LCS_PORTLET_STATE"));
      ...
      out.write('	');
if (
 (lcsPortletState == LCSPortletState.PLUGIN_ABSENT.intValue()) || (lcsPortletState == LCSPortletState.NOT_REGISTERED.intValue()) ) {
      out.write("\n");
      out.write("		<div class=\"alert alert-danger\" role=\"alert\">\n");
      out.write("			<span class=\"alert-indicator\">\n");
      out.write("				<svg class=\"lexicon-icon lexicon-icon-exclamation-full\" focusable=\"false\" role=\"presentation\" viewBox=\"0 0 512 512\">\n");
      ...
      out.write("			</span>\n");
      out.write("			<strong class=\"lead\">Error:</strong>\n");
      out.write("			This instance is not registered.\n");
      out.write("		</div>\n");
      out.write("\n");
      out.write("		<div class=\"sheet\">\n");
      out.write("			<div class=\"sheet-header\">\n");
      out.write("				<h1 class=\"sheet-title\">\n");
      out.write("					Liferay DXP Activation\n");
      out.write("				</h1>\n");
      out.write("\n");
      out.write("				<div class=\"sheet-text\">\n");
      out.write("					Administrators can use one of the options below to activate this Liferay DXP instance.\n");
      out.write("				</div>\n");
      out.write("			</div>\n");
      out.write("\n");
      out.write("			<div class=\"sheet-section\">\n");
      out.write("				<h2 class=\"sheet-subtitle\">\n");
      out.write("					Servers\n");
      out.write("				</h2>\n");
      out.write("\n");
      out.write("				<div class=\"sheet-text\">\n");
      out.write("					For non-production, backup and production instances, please navigate to the License Manager and deploy the activation key provided for this instance.\n");
      out.write("				</div>\n");
      out.write("\n");
      ...
      out.write("			<div class=\"sheet-section\">\n");
      out.write("				<h2 class=\"sheet-subtitle\">\n");
      out.write("					Local Workstations\n");
      out.write("				</h2>\n");
      out.write("\n");
      out.write("				<div class=\"sheet-text\">\n");
      out.write("					For local workstations, deploy your developer type activation key.\n");
      out.write("				</div>\n");
      out.write("\n");
      out.write("				<a class=\"btn btn-secondary\" href=\"//customer.liferay.com/en_US/activation-key\" target=\"_blank\">\n");
      out.write("					<svg class=\"lexicon-icon lexicon-icon-download\" viewBox=\"0 0 512 512\">\n");
      out.write("						<path class=\"download-arrow-down lexicon-icon-outline\" d=\"M233.2,374.5c13.1,13.2,33.5,12.2,45.6,0l71.3-71.6c29.8-29.9-14.3-77.2-45.6-45.8l-16.6,16.7V32.1c0-42.5-63.7-43-63.7,0v241.7l-16.6-16.7c-30.8-30.9-75.5,15.8-45.6,45.8L233.2,374.5z\"></path>\n");
      out.write("						<path class=\"download-border lexicon-icon-outline\" d=\"M384,384.5v63.8H128v-63.8c0-43.8-64-41.8-64,0V512h384V384.5C448,340.7,384,341.7,384,384.5z\"></path>\n");
      out.write("					</svg>\n");
      out.write("					Developer Key\n");
      out.write("				</a>\n");
      out.write("			</div>\n");
      out.write("\n");
      out.write("			<div class=\"sheet-section\">\n");
      out.write("				<h2 class=\"sheet-subtitle\">\n");
      out.write("					I Have A DXP Trial\n");
      out.write("				</h2>\n");
      out.write("\n");
      out.write("				<div class=\"sheet-text\">\n");
      ...
      out.write("				</div>\n");
      out.write("\n");
      out.write("				<a class=\"btn btn-secondary\" href=\"mailto:sales@liferay.com\">Contact Sales</a>\n");
      out.write("			</div>\n");
      out.write("\n");
      out.write("			<div class=\"sheet-section\">\n");
      out.write("				<h2 class=\"sheet-subtitle\">\n");
      out.write("					Further Assistance\n");
      out.write("				</h2>\n");
      out.write("\n");
      out.write("				<div class=\"sheet-text\">\n");
      out.write("					You may also contact Liferay Support for further assistance.\n");
      out.write("				</div>\n");
      out.write("\n");
      out.write("				<a class=\"btn btn-secondary\" href=\"//help.liferay.com/hc/en-us/requests/new\" target=\"_blank\">Contact Support</a>\n");
      out.write("			</div>\n");
      out.write("		</div>\n");
      out.write("	");
      out.write('\n');
 ...
 lcsPortletState == LCSPortletState.GOOD.intValue() ) {
      ...
      out.write("			<span class=\"alert-indicator\">\n");
      out.write("				<svg class=\"lexicon-icon lexicon-icon-check-circle-full\" focusable=\"false\" role=\"presentation\" viewBox=\"0 0 512 512\">\n");
      out.write("					<path class=\"lexicon-icon-outline\" d=\"M484.1,139.7c-54.4,62.6-167,190-203.8,233c-5.9,6.8-14.6,11.2-24.3,11.2c-8.8,0-16.8-3.6-22.6-9.4c-45.3-45.3-50.7-50.7-96-96c-5.8-5.8-9.4-13.8-9.4-22.6c0-17.7,14.3-32,32-32c8.8,0,16.8,3.6,22.6,9.4c35.6,35.6,46.6,46.6,71.6,71.6c47-54.8,150.9-171.7,192.5-219.7C399.8,32.9,331.8,0,256,0C114.6,0,0,114.6,0,256s114.6,256,256,256s256-114.6,256-256C512,214.1,501.9,174.6,484.1,139.7z\"></path>\n");
      out.write("				</svg>\n");
      out.write("			</span>\n");
      out.write("			<strong class=\"lead\">Success:</strong>\n");
      out.write("			This server is registered. Go to <a href=\"http://lcs.liferay.com\">http://lcs.liferay.com</a> to manage your activation keys.\n");
      out.write("		</div>\n");
      out.write("\n");
      out.write("		<div class=\"sheet\">\n");
      out.write("			<div class=\"sheet-header\">\n");
      ...
      out.write("\n");
      out.write("				<div class=\"sheet-text\">\n");
      out.write("					This server is registered. You can manage your activation key from LCS site.\n");
      out.write("				</div>\n");
      out.write("			</div>\n");
      out.write("\n");
      out.write("			<a class=\"btn btn-primary\" href=\"//lcs.liferay.com\" target=\"_blank\">Liferay Connected Services</a>\n");
      out.write("		</div>\n");
      out.write("	");
      out.write('\n');
      out.write('	');
 ...
 lcsPortletState == LCSPortletState.NO_CONNECTION.intValue() ) {
      out.write("\n");
      out.write("		<div class=\"alert alert-danger\" role=\"alert\">\n");
      out.write("			<span class=\"alert-indicator\">\n");
      out.write("				<svg class=\"lexicon-icon lexicon-icon-exclamation-full\" focusable=\"false\" role=\"presentation\" viewBox=\"0 0 512 512\">\n");
      ...
      out.write("			</span>\n");
      out.write("			<strong class=\"lead\">Error:</strong>\n");
      out.write("			Unable to connect to <a href=\"http://lcs.liferay.com\">http://lcs.liferay.com</a>. Please check your connection settings and restart.\n");
      out.write("		</div>\n");
      out.write("\n");
      out.write("		<div class=\"sheet\">\n");
      out.write("			<div class=\"sheet-header\">\n");
      ...
      out.write("				</div>\n");
      out.write("\n");
      out.write("				<a class=\"btn btn-secondary\" href=\"//help.liferay.com\" target=\"_blank\">Help Center</a>\n");
      out.write("			</div>\n");
      out.write("\n");
      out.write("			<div class=\"sheet-section\">\n");
      out.write("				<h2 class=\"sheet-subtitle\">\n");
