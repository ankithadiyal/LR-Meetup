...
public final class import_005fclient_005fextension_005fentry_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ClientExtensionAdminDisplayContext clientExtensionAdminDisplayContext = (ClientExtensionAdminDisplayContext)renderRequest.getAttribute(ClientExtensionAdminWebKeys.CLIENT_EXTENSION_ADMIN_DISPLAY_CONTEXT);
      ...
      _jspx_th_react_component_0.setModule("{ModalImportClientExtensionEntry} from client-extension-web");
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("importClientExtensionEntry',\n");
        out.write("\t\t() => {\n");
        out.write("\t\t\tLiferay.componentReady(\n");
        out.write("\t\t\t\t'");
        if (_jspx_meth_portlet_namespace_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
          return true;
        out.write("importClientExtensionEntryModal'\n");
        out.write("\t\t\t).then((importClientExtensionEntryModal) => {\n");
        out.write("\t\t\t\timportClientExtensionEntryModal.open();\n");
        out.write("\t\t\t});\n");
        out.write("\t\t}\n");
        out.write("\t);\n");
