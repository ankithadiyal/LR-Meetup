...
public final class edit_005fcustom_005felement_jsp extends org.apache.jasper.runtime.HttpJspBase
...
CustomElementCET customElementCET = editClientExtensionEntryDisplayContext.getCET();
      ...
      if (_jspx_eval_aui_field$1wrapper_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_0.setLabel("html-element-name");
        _jspx_th_aui_input_0.setName("htmlElementName");
        _jspx_th_aui_input_0.setRequired( true );
        _jspx_th_aui_input_0.setType("text");
        _jspx_th_aui_input_0.setValue( customElementCET.getHTMLElementName() );
      ...
      _jspx_th_aui_input_1.setLabel("use-esm");
      _jspx_th_aui_input_1.setName("useESM");
      _jspx_th_aui_input_1.setType("checkbox");
      _jspx_th_aui_input_1.setValue( customElementCET.isUseESM() );
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"lfr-form-rows\" id=\"");
      if (_jspx_meth_portlet_namespace_0(_jspx_page_context))
        return;
      out.write("_urls_field\">\n");
      out.write("\n");
      out.write("\t");
	...
	for (String url : editClientExtensionEntryDisplayContext.getStrings(customElementCET.getURLs())) {
      ...
      if (_jspx_eval_aui_field$1wrapper_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_2.setIgnoreRequestValue( true );
        _jspx_th_aui_input_2.setLabel("js-url");
        _jspx_th_aui_input_2.setName("urls");
        _jspx_th_aui_input_2.setRequired( true );
        _jspx_th_aui_input_2.setType("text");
        _jspx_th_aui_input_2.setValue( url );
        ...
        out.write("\n");
        out.write("\n");
        out.write("\t\t\t\t<div class=\"form-text form-text-repeat\">\n");
        out.write("\t\t\t\t\t");
	...
	for (String cssURL : editClientExtensionEntryDisplayContext.getStrings(customElementCET.getCSSURLs())) {
      ...
      if (_jspx_eval_aui_field$1wrapper_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_field$1wrapper_2);
        _jspx_th_aui_input_3.setIgnoreRequestValue( true );
        _jspx_th_aui_input_3.setLabel("css-url");
        _jspx_th_aui_input_3.setName("cssURLs");
        _jspx_th_aui_input_3.setType("text");
        _jspx_th_aui_input_3.setValue( cssURL );
      ...
      out.write('	');
if (
 editClientExtensionEntryDisplayContext.isAdding() ) {
      out.write("\n");
      out.write("\t\t");
      //  aui:input
      ...
      _jspx_th_aui_input_4.setLabel("instanceable");
      _jspx_th_aui_input_4.setName("instanceable");
      _jspx_th_aui_input_4.setType("checkbox");
      _jspx_th_aui_input_4.setValue( customElementCET.isInstanceable() );
      ...
      _jspx_th_aui_input_5.setLabel("instanceable");
      _jspx_th_aui_input_5.setName("instanceable-disabled");
      _jspx_th_aui_input_5.setType("checkbox");
      _jspx_th_aui_input_5.setValue( customElementCET.isInstanceable() );
      ...
      _jspx_th_aui_input_6.setName("instanceable");
      _jspx_th_aui_input_6.setType("hidden");
      _jspx_th_aui_input_6.setValue( customElementCET.isInstanceable() );
      ...
      _jspx_th_clay_select_0.setLabel("portlet-category-name");
      _jspx_th_clay_select_0.setName("portletCategoryName");
      _jspx_th_clay_select_0.setOptions( editClientExtensionEntryDisplayContext.getPortletCategoryNameSelectOptions(customElementCET.getPortletCategoryName()) );
      ...
      if (_jspx_eval_aui_field$1wrapper_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_field$1wrapper_3);
        _jspx_th_aui_input_7.setLabel("friendly-url-mapping");
        _jspx_th_aui_input_7.setName("friendlyURLMapping");
        _jspx_th_aui_input_7.setType("text");
        _jspx_th_aui_input_7.setValue( customElementCET.getFriendlyURLMapping() );
        ...
        out.write("\t<div class=\"form-text\">\n");
        out.write("\t\t");
        if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_field$1wrapper_3, _jspx_page_context))
          return;
        out.write("\n");
        out.write("\t</div>\n");
      }
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_field$1wrapper_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("specify-the-name-for-the-custom-element-thats-declared-in-its-javascript-file");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_field$1wrapper_1, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("enter-individual-urls-for-each-of-your-client-extension-javascript-files");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_field$1wrapper_2, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("enter-individual-urls-for-each-of-your-client-extension-css-files");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_field$1wrapper_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_3.setKey("define-the-widgets-friendly-url-mapping-so-you-can-refer-to-it-using-a-more-user-readable-url");
