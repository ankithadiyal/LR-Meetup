...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\tbodyHTML:\n");
          out.write("\t\t\t'");
          out.print( HtmlUtil.escapeJS((String)request.getAttribute(EPNWebKeys.MODAL_BODY_HTML)) );
          out.write("',\n");
          out.write("\t\tbuttons: [\n");
          out.write("\t\t\t{\n");
          out.write("\t\t\t\tdisplayType: 'primary',\n");
          out.write("\t\t\t\tlabel: '");
          if (_jspx_meth_liferay$1ui_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("',\n");
          out.write("\t\t\t\tonClick: function ({processClose}) {\n");
          out.write("\t\t\t\t\tLiferay.Util.fetch(\n");
          out.write("\t\t\t\t\t\t'");
          out.print( PortalUtil.getPortalURL(request) + PortalUtil.getPathModule() + "/com-liferay-enterprise-product-notification-web/confirm/" );
          out.write("',\n");
          out.write("\t\t\t\t\t\t{method: 'post'}\n");
          out.write("\t\t\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\t\t\tprocessClose();\n");
          out.write("\t\t\t\t},\n");
          out.write("\t\t\t},\n");
          out.write("\t\t],\n");
          out.write("\t\tsize: 'lg',\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_script_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_1.setKey("terms-of-use");
