...
if (
 layoutStructure != null ) {
      ...
      out.write('	');
      //  aui:link
      com.liferay.taglib.aui.LinkTag _jspx_th_aui_link_0 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(com.liferay.taglib.aui.LinkTag.class) : new com.liferay.taglib.aui.LinkTag();
      _jspx_th_aui_link_0.setPageContext(_jspx_page_context);
      _jspx_th_aui_link_0.setParent(null);
      _jspx_th_aui_link_0.setHref( renderLayoutUtilityPageEntryDisplayContext.getHref() );
      _jspx_th_aui_link_0.setRel("stylesheet");
      _jspx_th_aui_link_0.setSenna("temporary");
      _jspx_th_aui_link_0.setType("text/css");
      int _jspx_eval_aui_link_0 = _jspx_th_aui_link_0.doStartTag();
      if (_jspx_th_aui_link_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_aui_link_0);
        _jspx_th_aui_link_0.release();
        return;
      }
      if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_aui_link_0);
      _jspx_th_aui_link_0.release();
