...
portletDisplay.setShowExportImportIcon(false);
	...
	TermsOfUseContentProvider termsOfUseContentProvider = (TermsOfUseContentProvider)request.getAttribute(TermsOfUseContentProvider.class.getName());
        ...
        com.liferay.site.navigation.taglib.servlet.taglib.LanguageTag _jspx_th_liferay$1site$1navigation_language_0 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(com.liferay.site.navigation.taglib.servlet.taglib.LanguageTag.class) : new com.liferay.site.navigation.taglib.servlet.taglib.LanguageTag();
        _jspx_th_liferay$1site$1navigation_language_0.setPageContext(_jspx_page_context);
        _jspx_th_liferay$1site$1navigation_language_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1layout_render$1layout$1utility$1page$1entry_0);
        _jspx_th_liferay$1site$1navigation_language_0.setFormAction( updateLanguageFormAction );
        _jspx_th_liferay$1site$1navigation_language_0.setLanguageId( themeDisplay.getLanguageId() );
        _jspx_th_liferay$1site$1navigation_language_0.setLanguageIds( LocaleUtil.toLanguageIds(LanguageUtil.getAvailableLocales(themeDisplay.getCompanyGroupId())) );
        int _jspx_eval_liferay$1site$1navigation_language_0 = _jspx_th_liferay$1site$1navigation_language_0.doStartTag();
        if (_jspx_th_liferay$1site$1navigation_language_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
          if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1site$1navigation_language_0);
          _jspx_th_liferay$1site$1navigation_language_0.release();
          return;
        }
        if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1site$1navigation_language_0);
        _jspx_th_liferay$1site$1navigation_language_0.release();
...
if (
 !user.isAgreedToTermsOfUse() ) {
  ...
  private boolean _jspx_meth_clay_button_1(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_clay_button_1.setPropsTransformer("{DisagreeButtonPropsTransformer} from layout-utility-page-terms-of-use");
