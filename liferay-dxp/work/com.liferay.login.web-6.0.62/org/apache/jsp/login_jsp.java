...
if (
 themeDisplay.isSignedIn() ) {
      ...
      _jspx_th_portlet_actionURL_0.setSecure( request.isSecure() );
...
if (
 PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.ADMIN_EMAIL_USER_ADDED_ENABLED) ) {
        ...
        out.write("\t\t\t\t\t\t\t\t\t");
if (
 PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.LOGIN_CREATE_ACCOUNT_ALLOW_CUSTOM_PASSWORD, PropsValues.LOGIN_CREATE_ACCOUNT_ALLOW_CUSTOM_PASSWORD) ) {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t\t");
...
if (
 company.isSendPasswordResetLink() ) {
        ...
        _jspx_th_liferay$1ui_error_0.setMessage("authentication-failed-due-to-incorrect-credentials-or-account-lockout");
        ...
        _jspx_th_liferay$1ui_error_1.setException( AuthException.class );
        _jspx_th_liferay$1ui_error_1.setMessage("authentication-failed");
        ...
        _jspx_th_liferay$1ui_error_2.setMessage("unable-to-log-in-because-the-maximum-number-of-users-has-been-reached");
        ...
        _jspx_th_liferay$1ui_error_3.setException( CookieNotSupportedException.class );
        _jspx_th_liferay$1ui_error_3.setMessage("authentication-failed-please-enable-browser-cookies");
        ...
        _jspx_th_liferay$1ui_error_4.setException( NoSuchUserException.class );
        _jspx_th_liferay$1ui_error_4.setMessage("authentication-failed");
        ...
        _jspx_th_liferay$1ui_error_5.setException( PasswordExpiredException.class );
        _jspx_th_liferay$1ui_error_5.setMessage("your-password-has-expired");
        ...
        _jspx_th_liferay$1ui_error_7.setException( UserLockoutException.LDAPLockout.class );
        _jspx_th_liferay$1ui_error_7.setMessage("this-account-is-locked");
...
if (
 company.isSendPasswordResetLink() ) {
        ...
        _jspx_th_liferay$1ui_error_8.setException( UserLockoutException.PasswordPolicyLockout.class );
        _jspx_th_liferay$1ui_error_8.setMessage("authentication-failed-due-to-incorrect-credentials-or-account-lockout");
        ...
        _jspx_th_liferay$1ui_error_9.setMessage("authentication-failed");
        ...
        _jspx_th_liferay$1ui_error_10.setException( UserPasswordException.class );
        _jspx_th_liferay$1ui_error_10.setMessage("authentication-failed");
        ...
        _jspx_th_liferay$1ui_error_11.setException( UserScreenNameException.MustNotBeNull.class );
        _jspx_th_liferay$1ui_error_11.setMessage("the-screen-name-cannot-be-blank");
...
if (
 authType.equals(CompanyConstants.AUTH_TYPE_EA) ) {
          ...
          _jspx_th_aui_input_4.setRequired( true );
...
if (
 Validator.isNotNull(redirect) ) {
  ...
  private boolean _jspx_meth_aui_validator_0(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_input_3, PageContext _jspx_page_context)
    ...
    _jspx_th_aui_validator_0.setName("email");
  ...
  private boolean _jspx_meth_liferay$1ui_message_8(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_8.setKey("caps-lock-is-on");
