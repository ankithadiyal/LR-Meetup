...
if (
 searchBarPortletDisplayContext.isDestinationUnreachable() ) {
      out.write("\n");
      out.write("\t\t<div class=\"alert alert-info c-mb-0 text-center\">\n");
      out.write("\t\t\t");
      ...
      _jspx_th_clay_link_0.setLabel( LanguageUtil.get(request, "set-up-its-destination-to-make-it-visible") );
      _jspx_th_clay_link_0.setDynamicAttribute(null, "onClick",  portletDisplay.getURLConfigurationJS() );
      ...
      out.print( HtmlUtil.escapeAttribute(searchBarPortletDisplayContext.getSearchURL()) );
      out.write("\" id=\"");
      out.print( randomNamespace );
      out.write("fm\" method=\"get\" name=\"");
      out.print( randomNamespace );
      out.write("fm\">\n");
      out.write("\t\t\t");
if (
 !Validator.isBlank(searchBarPortletDisplayContext.getPaginationStartParameterName()) ) {
      ...
      _jspx_th_liferay$1ddm_template$1renderer_0.setClassName( SearchBarPortlet.class.getName() );
...
if (
 searchBarPortletDisplayContext.isSuggestionsEnabled() ) {
        ...
        _jspx_th_react_component_0.setModule("{ReactSearchBar} from portal-search-web");
...
if (
 searchBarPortletDisplayContext.isAvailableEverythingSearchScope() ) {
        ...
        _jspx_th_clay_button_0.setCssClass("search-bar-submit-button");
        ...
        out.write("\" autocomplete=\"off\" class=\"form-control input-group-inset input-group-inset-after search-bar-keywords-input\" data-qa-id=\"searchInput\" disabled=\"");
        out.print( true );
        out.write("\" id=\"");
        out.print( randomNamespace );
        ...
        _jspx_th_clay_button_1.setCssClass("search-bar-submit-button");
      ...
      _jspx_th_liferay$1frontend_component_0.setModule("{SearchBar} from portal-search-web");
