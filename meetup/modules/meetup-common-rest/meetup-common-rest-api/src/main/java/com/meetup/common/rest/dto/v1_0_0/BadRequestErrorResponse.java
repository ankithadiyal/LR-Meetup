 ...
 */
@Generated("")
@GraphQLName("BadRequestErrorResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "BadRequestErrorResponse")
public class BadRequestErrorResponse implements Serializable {

	public static BadRequestErrorResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(BadRequestErrorResponse.class, json);
	}

	public static BadRequestErrorResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			BadRequestErrorResponse.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.meetup.common.rest.dto.v1_0_0.BadRequestErrorResponse",
		name = "x-class-name"
	)
