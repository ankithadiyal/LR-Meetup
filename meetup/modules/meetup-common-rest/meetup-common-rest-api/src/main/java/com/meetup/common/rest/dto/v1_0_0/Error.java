...
public class Error implements Serializable {
	...
	public String getDetails() {
		if (_detailsSupplier != null) {
			details = _detailsSupplier.get();

			_detailsSupplier = null;
		}
	...
	public void setDetails(
		...
		_detailsSupplier = () -> {
			try {
				return detailsUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<String> _detailsSupplier;
	...
	@Schema(
		...
		defaultValue = "com.meetup.common.rest.dto.v1_0_0.Error",
		name = "x-class-name"
	)
