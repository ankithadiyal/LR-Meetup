 ...
 */
@Generated("")
@GraphQLName("InternalServerErrorResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "InternalServerErrorResponse")
public class InternalServerErrorResponse implements Serializable {
	...
	public static InternalServerErrorResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(
			InternalServerErrorResponse.class, json);
	}

	public static InternalServerErrorResponse unsafeToDTO(String json) {
	...
	@Schema(example = "Unable to add service. Please try again later.")
	...
	@Schema(
		...
		defaultValue = "com.meetup.common.rest.dto.v1_0_0.InternalServerErrorResponse",
		name = "x-class-name"
	)
