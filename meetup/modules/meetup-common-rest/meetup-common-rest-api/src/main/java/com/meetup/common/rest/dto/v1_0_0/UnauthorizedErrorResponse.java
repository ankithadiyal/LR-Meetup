 ...
 */
@Generated("")
@GraphQLName("UnauthorizedErrorResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UnauthorizedErrorResponse")
public class UnauthorizedErrorResponse implements Serializable {

	public static UnauthorizedErrorResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(
			UnauthorizedErrorResponse.class, json);
	}

	public static UnauthorizedErrorResponse unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "com.meetup.common.rest.dto.v1_0_0.UnauthorizedErrorResponse",
		name = "x-class-name"
	)
