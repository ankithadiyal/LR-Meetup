...
public abstract class BaseServiceEntityResourceImpl
	implements ServiceEntityResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/meetup-common-rest/v1.0.0/entity-list-new'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "ServiceEntity")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/entity-list-new")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Object getEntityListNew(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.QueryParam("propsData")
			String propsData,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseServiceEntityResourceImpl.class);
