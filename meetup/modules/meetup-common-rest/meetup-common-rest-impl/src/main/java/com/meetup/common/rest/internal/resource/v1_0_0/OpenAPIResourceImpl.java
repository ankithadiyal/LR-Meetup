...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Custom API to manage Service along with related Tickets and Schedule Maintenances in a one CRUD operation.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "MeetupCommonRest", version = "v1.0.0")
)
@Path("/v1.0.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(ServiceResourceImpl.class);

			add(ServiceEntityResourceImpl.class);
